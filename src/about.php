...
<body>
    <div class="main">
        ...
        <div class="content">
            <div class="part-1">
                <div class="branding">
                    <img id="brand-logo" src="/img/Branding-photo.png" alt="branding photo">
                </div>
                <div class="intro">
            ...
            <div class="part-2">
                ...
                <div class="part2-ii">
                    <br>
                    <img id="flocking" src="/img/feature_locking.jpg" alt="feature locking">
                </div>
            </div>
            <div class="part-3">
                <div class="part3-i">
                    <img id="laptop" src="/img/laptop.jpg" alt="laptop">
                </div>
                <div class="part3-ii">
            ...
            <div class="part4">
                <div class="part4-i">
                    <div class="feature-icon">
                        <div class="icon-img">
                            <img src="/img/private_lock.png" alt="icon">
                        </div>
                        <h2>100% Private</h2>
                        <p>
                    ...
                    <div class="feature-icon">
                        <div class="icon-img">
                            <img src="/img/phone_cell.png" alt="icon">
                        </div>
                    ...
                    <div class="feature-icon">
                        <div class="icon-img">
                            <img src="/img/alarm_icon.png" alt="icon">
                        </div>
                ...
                <div class="part4-i">
                    <div class="feature-icon">
                        <div class="icon-img">
                            <img src="/img/customizable_icon.png" alt="icon">
                        </div>
                    ...
                    <div class="feature-icon">
                        <div class="icon-img">
                            <img id="sjournal-icon" src="/img/smart_journal.png" alt="icon">
                        </div>
                    ...
                    <div class="feature-icon">
                        <div class="icon-img">
                            <img src="/img/locker.png" alt="icon">
                        </div>
